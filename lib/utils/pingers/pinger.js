...
export default class Pinger {
  constructor (props) {
    const _this = this;
    const { pingerName, wsServerAddress, onChangeState } = props;
    _this.pingerName = pingerName;
    _this.wsServerAddress = wsServerAddress + '/' + pingerName;
  ...
  onMessage (msg) {
    const _this = this;
    l.log('pinger ' + _this.wsServerAddress + '!!!!!! pinger: incoming message.', msg);
  ...
  onChangeState (pingerName, newState) {
    const _this = this;
    l.log('pinger ' +pingerName + ': ' + _this.wsServerAddress + ' local pinger state chaged.', newState);
  }
};
